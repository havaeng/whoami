...
export const sv: TranslationDictionary = {
  ...
  sections: {
    ...
    education: {
      ...
      entries: [
        ...
        },
        {
          ...
          logo: '/trv5.png',
          items: [
            'LIA-praktik (lärande i arbete) på SJ AB (Malmö), Hector Rail (Malmö) och Transdev Sverige AB (Öresundståg, Malmö)',
          ],
        },
      ],
    },
    nonProfit: {
      ...
      entries: [
        { organisation: 'BRF Bergsspånet',            role: 'Sekreterare',    period: '2023 – 2025', logo: '/brf.jpg' },
        { organisation: 'Militärmusiksamfundet',      role: 'Ledamot',        period: '2016 – 2026', logo: '/mms.png' },
        { organisation: 'Seko Klubb SJ Syd',          role: 'Kassör',         period: '2019 – 2022', logo: '/seko.png' },
        { organisation: 'Hemvärnets musikkår Lund',   role: 'Kassör',         period: '2019 – 2020', logo: '/hvmus.png' },
        { organisation: 'Göta Brass Band',            role: 'Sekreterare',    period: '2016 - 2017', logo: '/gota.png' },
        { organisation: 'Göta Brass Band',            role: 'Vice ordförande', period: '2014 – 2016', logo: '/gota.png' },
        { organisation: 'Marinens ungdomsmusikkår',   role: 'Ledamot',        period: '2014 – 2016', logo: '/muk.png' },
        { organisation: 'Marinens ungdomsmusikkår',   role: 'Suppleant',      period: '2013 – 2014', logo: '/muk.png' },
        { organisation: 'Hemvärnets musikkår Eslöv',  role: 'Suppleant',      period: '2013 – 2014', logo: '/hvmus.png' },
        { organisation: 'Sjöbo ungdomsorkester',      role: 'Ledamot',        period: '2006 – 2007', logo: '/suo.png' },
      ],
    },
  },
}
